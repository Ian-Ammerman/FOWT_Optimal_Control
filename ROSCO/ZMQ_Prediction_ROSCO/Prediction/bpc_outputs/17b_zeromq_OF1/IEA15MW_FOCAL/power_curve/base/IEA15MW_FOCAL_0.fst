...
---------------------- INPUT FILES ---------------------------------------------
"IEA15MW_FOCAL_0_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA15MW_FOCAL_0_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"IEA15MW_FOCAL_0_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA15MW_FOCAL_0_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"IEA15MW_FOCAL_0_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"unused"               SubFile     - Name of file containing sub-structural input parameters (quoted string)
"IEA15MW_FOCAL_0_MoorDyn.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)
