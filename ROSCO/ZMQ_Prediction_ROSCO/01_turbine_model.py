...
out_dir = os.path.join(this_dir,'bpc_outputs')
if not os.path.isdir(out_dir):
  os.makedirs(out_dir)

turbine.save(os.path.join(out_dir,'01_IEA15MW_FOCAL_saved.p'))

# Now load the turbine and plot the Cp surface

# Load quick from python pickle
turbine = turbine.load(os.path.join(out_dir,'01_IEA15MW_FOCAL_saved.p'))
...
if False:
  ...
  plt.savefig(os.path.join(out_dir,'01_IEA15MW_FOCAL_Cp.png'))